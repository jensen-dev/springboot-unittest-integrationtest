...
import com.unittest.springBootTesting.integration.AbstractContainerBaseTest;
...
class EmployeeRepositoryIntegrationTest extends AbstractContainerBaseTest {
    ...
    public void givenEmployeesList_whenFindAll_thenEmployeesList() {
        // given - setup
        Employee employee2 = Employee.builder().firstName("chelia").lastName("kusumo").email("chelia.kusumo@email.com").build();
